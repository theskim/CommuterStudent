...
const tips = {
    "Go Train Tips": {
        "tips": [
                  ...
                  "Don’t forget to set a default trip. If your PRESTO card has a default trip set for travel between two stations, you only have to tap on. If you take a trip that begins or ends at a different station, you have to tap on and off.",
    ...
    "TTC Tips": {
        "tips": [
                  ...
                  "Queens Park, Museum, and St. George stations are close to Campus, Queen's Park being the closest to the Engineering Buildings.",
                  "If you commuting from Finch Side (Line 1), you can walk to campus from College station (about 12-minute walk)",
